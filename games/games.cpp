...
int startGame(string mode) {
    ...
    // Example questions for Future Simple
        ...
        score += fillInTheBlanks("He _ (go) to the park tomorrow.", "will go");
    }
